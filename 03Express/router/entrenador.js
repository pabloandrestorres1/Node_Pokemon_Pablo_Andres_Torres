...
const Entrenador = require('../models/entrenador.js');
...
router.get('/:id', async(req, res) => { //El id vendrá por el GET (barra de direcciones)
    ...
    try {
        ...
        res.render('detallentrenador', { //Para mostrar el objeto en la vista "detalle", que tenemos que crear
            entrenador: entrenadorDB,
            error: false
        })
    } catch (error) { //Si el id indicado no se encuentra
        console.log('Se ha producido un error', error)
        res.render('detallentrenador', { //Mostraremos el error en la vista "detalle"
            error: true,
